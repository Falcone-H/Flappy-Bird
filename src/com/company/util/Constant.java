...
public class Constant {
    ...
    //图像资源路径
    public static final String BG_ING_PATH = "resources/img/background.png";

    //小鸟图片
    public static final String[][] BIRDS_ING_PATH = {
    ...
    //云朵图片
    public static final String[] CLOUDS_ING_PATH = {"resources/img/cloud_0.png", "resources/img/cloud_1.png"};

    //水管图片
    public static final String[] PIPE_IMG_PATH = {
            "resources/img/pipe.png", "resources/img/pipe_top.png",
    ...
    public static final String SCORE_FILE_PATH = "resources/score"; //分数路径
